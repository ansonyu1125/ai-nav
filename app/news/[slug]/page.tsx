  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      ...
      <div className="mt-6 flex flex-wrap items-center gap-3">
        ...
        <span className="text-xs text-slate-400">来源：{article.source}</span>
      </div>
      ...
      {others.length > 0 && (
        <section className="mt-12">
          <h2 className="mb-4 text-xl font-bold text-slate-900">更多资讯</h2>
            ...
            {others.map((a) => (
              ...
              >
                <div className="min-w-0">
                  ...
                  <div className="line-clamp-1 text-sm text-slate-500">{a.summary}</div>
                </div>
              </Link>
            ))}
          </div>
